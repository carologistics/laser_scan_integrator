...
def launch_nodes_withconfig(context, *args, **kwargs):
    ...
    rviz_config_dir = os.path.join(
        ...
        "rviz",
        launch_configuration["namespace"] + "_rvizconfig.rviz",
    )
...
def generate_launch_description():
    ...
    declare_integratedframe_argument = DeclareLaunchArgument(
        "integratedFrameId",
        default_value="robotinobase1/laser_link",
        description="Integrated Frame ID",
    )

    declare_scantopic1_argument = DeclareLaunchArgument(
        "scanTopic1",
        default_value="/robotinobase1/SickLaser_Front_Remaped",
    ...
    declare_scantopic2_argument = DeclareLaunchArgument(
        "scanTopic2",
        default_value="/robotinobase1/SickLaser_Rear_Remaped",
